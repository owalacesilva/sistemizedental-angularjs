...
.directive('ngTimepicker', ['$document', function($document) {
    ...
    scope: {
      step: '='
		...
		template:
		'<input type="text" ng-focus="showTimepicker()" ng-value="viewValue" class="form-control" placeholder="00:00">' +
		...
		'      </tr>' +
		'      <tr>' +
		'        <td><input type="text" ng-model="hour" class="form-control"></td>' +
		'        <td>:</td>' +
		'        <td><input type="text" ng-model="minutes" class="form-control"></td>' +
