 ...
 */
ProductsCtrl.$inject = ['$scope', '$compile',  '$http', '$uibModal', '$state', '$filter', 'DoctorsCache', 'ProductCategory', 'Product', 'toasty', 'DTOptionsBuilder', 'DTColumnBuilder'];
function ProductsCtrl($scope, $compile,  $http, $uibModal, $state, $filter, DoctorsCache, ProductCategory, Product, toasty, DTOptionsBuilder, DTColumnBuilder) {
  var vm = this;
...
angular.module('sistemizedental').controller("ProductsCtrl", ProductsCtrl);